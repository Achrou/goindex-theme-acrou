      ...
      <div class="field has-addons is-rounded" style="margin-bottom: 0;">
        <div class="control has-icons-left has-icons-right is-dark" style="width:100%;">
          <input
            ...
            :style="
              'background-color: rgb(68, 66, 66);border-color: #272727;border-top-left-radius: 290486px;border-bottom-left-radius: 290486px;' +
        ...
        <div class="control">
          <a
            class="button"
            style="background-color: rgb(68, 66, 66);border-color: #272727;border-left: 0;border-top-right-radius: 290486px;border-bottom-right-radius: 290486px;"
            @click="optnOptions"
          >
